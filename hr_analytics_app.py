        ...
        if page == "⚖️ مستشار القضايا العمالية":
            ...
            **المصادر المعتمدة:**
            ...
            if submitted and labor_q:
                # Clear old chat - show only latest Q&A
                st.session_state.labor_chat = []
            ...
            **المناهج المعتمدة:**
            ...
            if submitted and hr_q:
                ...
                HR_INSTANT = {
                    ...
                    "ما الفرق بين OKRs و KPIs؟": "**OKRs vs KPIs:**\n\n**KPIs (مؤشرات الأداء الرئيسية):**\n- تقيس الأداء المستمر والحالي\n- أرقام محددة مثل: معدل دوران 15%\n- ثابتة نسبياً خلال السنة\n- تُظهر الوضع الراهن\n\n**OKRs (الأهداف والنتائج الرئيسية):**\n- تحدد أهداف طموحة للمستقبل\n- هدف واحد + 3 إلى 5 نتائج قابلة للقياس\n- تتغير كل ربع سنة\n- 70% إنجاز يُعتبر ممتاز\n\n**مثال تطبيقي في HR:**\n- **KPI:** معدل الدوران الوظيفي = 12%\n- **OKR:**\n  هدف: تحسين الاحتفاظ بالمواهب\n  - خفض الدوران الطوعي من 15% إلى 10%\n  - رفع نتيجة استبيان الرضا إلى 85%\n  - تنفيذ برنامج تطوير قيادي لـ 50 موظفاً",
                    "ما هو نموذج Phillips ROI للتدريب؟": "**نموذج Phillips ROI ذو الخمسة مستويات:**\n\n**المستوى 1 - Reaction (رد الفعل):**\nقياس رضا المتدربين عن البرنامج\n\n**المستوى 2 - Learning (التعلم):**\nقياس المعرفة والمهارات المكتسبة فعلياً\n\n**المستوى 3 - Application (التطبيق):**\nمدى تطبيق ما تعلموه في بيئة العمل\n\n**المستوى 4 - Impact (الأثر):**\nالتأثير المباشر على مؤشرات الأعمال\n\n**المستوى 5 - ROI (العائد على الاستثمار):**\n\nROI % = (الفوائد المالية - التكاليف) / التكاليف × 100\n\n**مثال عملي:**\nبرنامج تدريب بتكلفة 50,000 ريال أدى لزيادة إنتاجية بقيمة 150,000 ريال\nROI = (150,000 - 50,000) / 50,000 × 100 = **200%**",
                    "كيف أصمم هيكل رواتب تنافسي؟": "**تصميم هيكل رواتب تنافسي:**\n\n**1. المسح السوقي:**\n- مسح رواتب السوق (Salary Survey)\n- تحديد P25 و P50 و P75 لكل وظيفة\n- مقارنة مع القطاع والمنطقة\n\n**2. بناء الهيكل:**\n- تقييم الوظائف (Job Evaluation)\n- تصميم درجات وظيفية (Job Grading)\n- تحديد نطاق راتب لكل درجة: Min - Mid - Max\n- Compa-Ratio = الراتب الفعلي / وسط النطاق\n\n**3. السياسات:**\n- التوظيف عند Min إلى Mid\n- الزيادات السنوية 3% إلى 5%\n- مكافآت الأداء 10% إلى 20%\n- مراجعة سنوية مع تحديث بيانات السوق",
                    "كيف أحسب معدل دوران الموظفين وأحسّنه؟": "**معدل الدوران الوظيفي (Turnover Rate):**\n\n**المعادلة:**\nTurnover Rate = (عدد المغادرين / متوسط عدد الموظفين) × 100\n\n**المعايير المرجعية:**\n- أقل من 10%: ممتاز\n- 10% إلى 15%: جيد\n- 15% إلى 25%: يحتاج انتباه\n- أكثر من 25%: مشكلة تستدعي تدخل\n\n**استراتيجيات التحسين:**\n1. رواتب ومزايا تنافسية\n2. مسار وظيفي واضح\n3. بيئة عمل محفزة\n4. برامج تقدير وتحفيز\n5. مرونة في ساعات وبيئة العمل\n6. تطوير القيادات والمديرين\n7. استبيانات رضا دورية مع خطط تحسين",
                    "ما هي أفضل ممارسات تجربة الموظف (EX)؟": "**تجربة الموظف (Employee Experience):**\n\n**1. مرحلة الاستقطاب:**\n- عملية توظيف سلسة وشفافة\n- تواصل مستمر مع المرشحين\n\n**2. مرحلة التهيئة (Onboarding):**\n- خطة 30/60/90 يوم منظمة\n- تعيين Buddy أو مرشد\n- تعريف بالثقافة والقيم\n\n**3. مرحلة التطوير:**\n- تدريب مستمر ومتنوع\n- مسار وظيفي واضح\n- تغذية راجعة دورية\n\n**4. مرحلة الاحتفاظ:**\n- بيئة عمل محفزة وإيجابية\n- برامج تقدير ومكافآت\n- توازن العمل والحياة\n\n**5. مرحلة الانتقال:**\n- مقابلة خروج احترافية\n- شهادة خبرة\n- شبكة خريجين (Alumni Network)",
                }
                answer = None
