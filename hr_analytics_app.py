...
def build_reasoning_context(question, advisor_type, analysis, retrieved_context=""):
    ...
    if advisor_type == "legal":
        ...
        if facts:
            ...
            # No specific topic matched - inject general reference to prevent hallucination
            header += "\n📋 **مرجع المواد (لا تخترع أرقاماً غير موجودة هنا):**\n"
            header += "م42-48: التدريب | م49-60: العقود | م53: التجربة | م55: تحول العقد | م64: شهادة الخبرة | م66-72: الجزاءات والتأديب | م74-82: إنهاء العقد | م77: تعويض الفسخ | م80: فسخ مشروع (اعتداء/غياب) | م81: ترك بدون إشعار | م84-88: المكافأة | م89-97: الأجور | م98-107: ساعات العمل | م109-116: الإجازات | م121-130: المرأة | م131-155: السلامة والإصابات | م151: الوضع | م156-178: العمل البحري | م200-231: النزاعات\n"
        header += f"\n⚠️ إذا لم تجد المادة الدقيقة في القائمة أعلاه، قل 'لم أتمكن من تحديد المادة بدقة' ولا تخترع رقماً.\n\n"
