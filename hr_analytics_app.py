...
class ModelOrchestrator:
    ...
    def __init__(self):
        ...
        self._instant = {
            "ما هي حقوقي عند الفصل وفق المادة 77؟": "**المادة 77 من نظام العمل السعودي:**\n\nإذا أُنهي العقد لسبب غير مشروع، يُحدد التعويض كالتالي:\n\n**أولاً: إذا تضمّن العقد شرط تعويض محدد:**\nيُطبّق ما اتفق عليه الطرفان في العقد (هذا هو الأصل).\n\n**ثانياً: إذا لم يتضمن العقد شرط تعويض (الحالة الافتراضية):**\n- **عقد غير محدد المدة:** أجر 15 يوماً عن كل سنة خدمة\n- **عقد محدد المدة:** أجر المدة الباقية من العقد\n- **الحد الأدنى في الحالتين:** لا يقل التعويض عن أجر شهرين\n\n**بالإضافة إلى:**\n- مكافأة نهاية الخدمة (المادة 84)\n- بدل إجازة غير مستخدمة\n- أجر الشهر الأخير كاملاً\n- شهادة خبرة",
            ...
            "ما هي نسبة اشتراكات التأمينات الاجتماعية؟": "**نسب الاشتراك في التأمينات الاجتماعية (GOSI):**\n\n**أولاً: المشتركون الحاليون (قبل 3 يوليو 2024):**\n- المعاشات: 9% موظف + 9% شركة\n- ساند: 0.75% + 0.75%\n- أخطار مهنية: 2% شركة\n- **إجمالي الموظف: 9.75%** | **إجمالي الشركة: 11.75%**\n\n**ثانياً: الملتحقون الجدد (بعد 3 يوليو 2024 بدون اشتراك سابق):**\nالمعاشات تزداد تدريجياً 0.5% سنوياً حتى 11% بحلول 2028:\n- يوليو 2024 - يونيو 2025: 9% + 9%\n- يوليو 2025 - يونيو 2026: 9.5% + 9.5%\n- يوليو 2026 - يونيو 2027: 10% + 10%\n- يوليو 2027 - يونيو 2028: 10.5% + 10.5%\n- يوليو 2028 وما بعد: 11% + 11%\n+ ساند 0.75%+0.75% + أخطار 2%\n- **الموظف الجديد حالياً (2025-2026): 10.25%** | **الشركة: 12.25%**\n\n**غير السعوديين:** 2% أخطار مهنية على الشركة فقط.\n\n**سن التقاعد:** النظام القديم 60 سنة | النظام الجديد 65 سنة",
...
- أجب بنفس لغة السؤال. إذا السؤال بالإنجليزية أجب بالإنجليزية. إذا بالعربية أجب بالعربية.
"""
...
LABOR_KB = {
    ...
    "تأمينات|تأمين اجتماعي|gosi|اشتراك|خصم|نسبة الاشتراك|أخطار مهنية|social insurance|pension|retirement|تقاعد": "**نظام التأمينات الاجتماعية (GOSI) - يشمل النظام القديم والجديد:**\n\n**النظام القديم (مشتركون قبل 3/7/2024):**\n- المعاشات: 9% موظف + 9% شركة\n- ساند: 0.75% + 0.75%\n- أخطار: 2% شركة\n- **إجمالي الموظف: 9.75%** | **الشركة: 11.75%**\n\n**النظام الجديد (ملتحقون جدد بعد 3/7/2024 بدون اشتراك سابق):**\n- المعاشات: تزداد تدريجياً من 9% إلى 11% بحلول 2028 (زيادة 0.5% سنوياً)\n- حالياً (يوليو 2025-يونيو 2026): **9.5% موظف + 9.5% شركة**\n- ساند: 0.75% + 0.75%\n- أخطار: 2% شركة\n- **إجمالي الموظف الجديد حالياً: 10.25%** | **الشركة: 12.25%**\n- سن التقاعد الجديد: **65 سنة** (بدل 60)\n- التقاعد المبكر: 55 سنة مع 360 شهر اشتراك\n\n**غير السعوديين:** 2% أخطار على الشركة فقط.\n\n**الأجر الخاضع:** الأساسي + السكن (أقصى 45,000)\n\n**ساند:** 60% لأول 3 أشهر ثم 50% لـ9 أشهر (أقصى 9,000).",
    ...
    "إجازة|إجازات|سنوية|مرضية|annual|leave|عطلة|راحة|vacation|holiday|sick leave|maternity|paternity|أبوة": "**الإجازات في نظام العمل:**\n\n**السنوية (المادة 109):**\n- أول 5 سنوات: 21 يوماً\n- بعد 5 سنوات: 30 يوماً\n- لا يجوز التنازل عنها\n\n**المرضية (المادة 116):**\n- 30 يوماً بأجر كامل\n- 60 يوماً بثلاثة أرباع الأجر\n- 30 يوماً بدون أجر\n\n**إجازات أخرى:**\n- وفاة: 5 أيام | زواج: 5 أيام | مولود: 3 أيام (المادة 112)\n- حج: 10-15 يوماً (لمرة واحدة)\n- عيد الفطر: 4 أيام | عيد الأضحى: 4 أيام\n- أبوة: 3 أيام (المادة 113)\n- اليوم الوطني + يوم التأسيس",
    "ساعات|دوام|عمل اضافي|أوفرتايم|overtime|وقت العمل|working hours|رمضان|غياب|تغيب|انقطاع|absence": "**ساعات العمل (المادة 98):**\n\n- العادية: 8 ساعات/يوم أو 48 ساعة/أسبوع\n- رمضان: 6 ساعات/يوم أو 36 ساعة/أسبوع\n- العمل الإضافي (المادة 107): أجر الساعة + 50%\n- لا يزيد الإضافي عن 720 ساعة سنوياً\n- راحة: 30 دقيقة بعد كل 5 ساعات متواصلة\n- يوم راحة أسبوعي: الجمعة عادة",
    "استقالة|أستقيل|resignation|ترك العمل|إشعار|resign|quit|leaving|أبغى أترك|أريد أستقيل": "**الاستقالة:**\n\n**الإشعار (المادة 75):** 60 يوماً من صاحب العمل، 30 يوماً من العامل (للعقد غير المحدد)\n\n**المكافأة عند الاستقالة (المادة 85):**\n- أقل من سنتين: لا يستحق\n- 2-5 سنوات: ثلث المكافأة\n- 5-10 سنوات: ثلثا المكافأة\n- أكثر من 10: كاملة\n\n**ترك العمل بدون إشعار (المادة 81):** عند عدم دفع الأجر أو الاعتداء أو الغش في العقد.",
    "فصل|إنهاء|طرد|termination|إقالة|فسخ|عزل|fired|dismissed|terminated|فصلوني|فصلني|طردوني": "**إنهاء العقد:**\n\n**فصل بدون مكافأة (المادة 80):** اعتداء على صاحب العمل، إخلال جوهري بالالتزامات، غياب أكثر من 30 يوماً متفرقة أو أكثر من 15 يوماً متصلة في السنة (بعد إنذار كتابي عند 20 متفرقة أو 10 متصلة)، تزوير، إفشاء أسرار، استغلال المنصب\n\n**إنهاء غير مشروع (المادة 77):**\n- إذا تضمّن العقد تعويضاً محدداً: يُعمل بالعقد (الأصل)\n- إذا لم يتضمن: غير محدد = 15 يوم/سنة | محدد = أجر المدة الباقية | الحد الأدنى: شهرين\n+ مكافأة نهاية الخدمة (م84) + بدل إجازات + شهادة خبرة",
    "مكافأة|نهاية الخدمة|end of service|eos|مكافاة|gratuity|indemnity|severance": "**مكافأة نهاية الخدمة (المادة 84):**\n\n- أول 5 سنوات: نصف راتب عن كل سنة\n- بعد 5 سنوات: راتب كامل عن كل سنة\n- أجزاء السنة تُحسب نسبياً\n\n**عند الاستقالة (المادة 85):**\n- أقل من سنتين: صفر\n- 2-5 سنوات: ثلث\n- 5-10: ثلثان\n- أكثر من 10: كاملة\n\n**التسوية:** خلال أسبوع (المادة 88).",
    ...
    "عقد|عقود|contract|أنواع العقود|محدد|غير محدد|employment contract|تجديد|renewal": "**أنواع العقود:** محدد المدة | غير محدد (سعوديين) | مهمة | موسمي | تدريب | دوام جزئي\n\nالمادة 55: يتحول المحدد لغير محدد بعد 3 تجديدات أو 4 سنوات.\nالمادة 50: يجب أن يكون مكتوباً من نسختين.",
    "فترة التجربة|تجربة|probation|trial period|تحت التجربة": "**فترة التجربة (المادة 53 - المعدلة بمرسوم م/44 لعام 2025):**\n- 180 يوماً كحد أقصى من بداية العقد\n- التمديد: محظور بعد التعديل (لا يجوز التمديد)\n- لا تشمل الأعياد والإجازات المرضية\n- لأي طرف الإنهاء بدون تعويض أو مكافأة\n- لا تتكرر لدى نفس صاحب العمل\n\n⚠️ تنبيه: قبل التعديل كانت 90 يوماً قابلة للتمديد. الآن 180 يوماً من البداية والتمديد محظور.",
    "حقوق المرأة|المرأة|امرأة|حامل|وضع|رضاعة|أمومة|maternity|pregnancy|breastfeeding|women rights": "**حقوق المرأة العاملة:**\n- إجازة وضع: 12 أسبوعاً (المادة 151)\n- رضاعة: ساعة يومياً لـ 24 شهراً\n- حماية من الفصل أثناء الحمل والوضع\n- إجازة وفاة الزوج: 4 أشهر و10 أيام\n- المساواة في الأجر\n- بيئة عمل آمنة",
    ...
    "تعدي|اعتداء|ضرب|إهانة|إساءة|ظلم|قسوة|تحرش|سب|شتم|تهديد|عنف|أهانني|ضربني|تعدى علي|اعتدى علي|تم التعدي|assault|harassment|abuse|violence|bullying|insulted|attacked": "**التعدي والاعتداء في بيئة العمل:**\n\n**إذا تعدى صاحب العمل على العامل (المادة 81):**\nيحق للعامل ترك العمل فوراً بدون إشعار مع الاحتفاظ بحقوقه النظامية:\n- مكافأة نهاية الخدمة كاملة (المادة 84)\n- بدل إجازات غير مستخدمة\n- تسوية خلال أسبوع (المادة 88)\n- الحالات: اعتداء جسدي أو لفظي، إهانة، قسوة في المعاملة، تحرش، عدم معالجة ظلم\n\n**إذا اعتدى العامل على صاحب العمل (المادة 80):**\nيحق لصاحب العمل فسخ العقد بدون مكافأة أو إشعار أو تعويض\n- يشمل: الاعتداء بالقول أو الفعل على صاحب العمل أو المدير أو أحد الرؤساء أثناء العمل\n\n**الإجراءات المنصوح بها:**\n- توثيق الواقعة كتابياً\n- تقديم شكوى لمكتب العمل\n- رفع دعوى أمام المحكمة العمالية",
}
...
LEGAL_TOPICS = {
    ...
    "contracts":       {"kw": ["عقد","عقود","محدد المدة","غير محدد","تجديد","عقد عمل","تحويل العقد"], "ref": "م49-60", "label": "العقود",
        "facts": "م50: عقد مكتوب من نسختين. م51: يتضمن الاسم والجنسية والأجر ونوع العمل والمدة. م53: فترة التجربة 180 يوماً كحد أقصى من بداية العقد (المعدلة بمرسوم م/44). التمديد محظور بعد التعديل. لا تشمل إجازة العيدين والمرضية. م55: يتحول لغير محدد بعد 3 تجديدات أو 4 سنوات."},
    ...
    "leave":           {"kw": ["إجازة","إجازات","سنوية","مرضية","وفاة","زواج","حج","مولود","إجازة سنوية"], "ref": "م109-116", "label": "الإجازات",
        "facts": "م109: سنوية 21 يوم (أول 5 سنوات) ثم 30 يوم. م110: يجوز تأجيلها بموافقة. م112: وفاة 5 أيام، زواج 5، مولود 3. م113: أبوة 3 أيام. م116: مرضية 30 يوم كامل + 60 يوم 75% + 30 بدون. م115: حج 10-15 يوم لمرة واحدة."},
    ...
    "probation":       {"kw": ["تجربة","فترة التجربة","فترة الاختبار"], "ref": "م53-54", "label": "فترة التجربة",
        "facts": "م53: 180 يوماً كحد أقصى من بداية العقد (المعدلة بمرسوم م/44). التمديد: محظور بعد التعديل. لا تدخل فيها إجازة العيدين والمرضية. لكلا الطرفين الإنهاء بدون تعويض أو مكافأة. لا تتكرر لدى نفس صاحب العمل."},
    "women":           {"kw": ["المرأة","حامل","وضع","رضاعة","أمومة","إجازة وضع","حقوق المرأة"], "ref": "م121-130,م151", "label": "المرأة العاملة",
        "facts": "م151: إجازة وضع 12 أسبوعاً (4 قبل كحد أقصى). ساعة رضاعة يومياً لـ 24 شهر. حماية من الفصل أثناء الحمل والوضع وبعده 180 يوم. عدة 4 أشهر و10 أيام."},
    "insurance":       {"kw": ["تأمين","تأمينات","تأمينات اجتماعية","gosi","ساند","تقاعد","اشتراك","معاش"], "ref": "نظام التأمينات", "label": "التأمينات الاجتماعية",
        "facts": "سعودي قديم: 9.75% خصم + 11.75% شركة. سعودي جديد (بعد 7/2024): حالياً 10.25% + 12.25%. غير سعودي: 2% أخطار فقط. ساند: 0.75%+0.75%. التقاعد: سن 60 + 120 شهر أو 300 شهر مبكر. ساند: 60% لـ 3 أشهر ثم 50% لـ 9 أشهر أقصى 9000."},
...
def build_reasoning_context(question, advisor_type, analysis, retrieved_context=""):
    ...
    if advisor_type == "legal":
        ...
        if facts:
            ...
            header += "**الباب 11 - الإجازات (م108-116):** م109 سنوية 21 يوم عادي (أول 5 سنوات) ثم 30 يوم (بعدها)، م110 تأجيل الإجازة بموافقة العامل، م111 أجر الإجازة مقدماً، م112 مناسبات: وفاة 5 أيام/زواج 5/مولود 3، م113 أبوة 3 أيام، م115 حج 10-15 يوم لمرة واحدة (بعد سنتين)، م116 مرضية: 30 يوم كامل الأجر + 60 يوم ثلاثة أرباع + 30 يوم بدون أجر (في السنة)\n"
            ...
            header += "**الباب 15 - إصابات العمل والتعويضات (م146-155):** م146 تعريف إصابة العمل، م149 العلاج على نفقة صاحب العمل، م150 أجر كامل خلال العلاج حتى سنة، م151 إجازة الوضع 12 أسبوعاً + ساعة رضاعة يومياً لـ24 شهر + حماية من الفصل أثناء الحمل والوضع و180 يوم بعده + عدة 4 أشهر و10 أيام، م152 حق الجمع بين التعويضات\n"
            ...
            header += "**التأمينات الاجتماعية (GOSI):** سعودي قديم (قبل 7/2024): معاشات 9%+9% + أخطار 2% + ساند 0.75%+0.75% = عامل 9.75% + شركة 11.75%. سعودي جديد (بعد 7/2024): معاشات تدريجية حالياً 9.5%+9.5% = عامل 10.25% + شركة 12.25%. التقاعد الجديد 65 سنة. غير سعودي: أخطار 2% فقط على الشركة. ساند: 60% لأول 3 أشهر ثم 50% لـ9 أشهر (أقصى 9000). التقاعد: سن 60 + 120 شهر اشتراك أو 300 شهر مبكر\n"
...
def verify_and_correct_response(response, consultant_type="legal"):
    """Post-process AI response to catch and correct known errors - comprehensive version."""
    if not response or consultant_type != "legal": return response
    import re

    # === CRITICAL CORRECTIONS (verified against Royal Decree م/44, 2025) ===
    corrections = {
        # Article 53 - Probation (most common AI error)
        '90 يوماً كحد أقصى': '180 يوماً كحد أقصى (المعدلة بمرسوم م/44)',
        '90 يوم كحد أقصى': '180 يوماً كحد أقصى (المعدلة 2025)',
        '90 يوما كحد أقصى': '180 يوماً كحد أقصى (المعدلة 2025)',
        'تمديد إلى 180': '180 يوماً من البداية (التمديد محظور بعد التعديل)',
        'يجوز تمديدها إلى 180 يوماً': '180 يوماً كحد أقصى من البداية (التمديد محظور بعد التعديل)',
        'يمكن تمديدها إلى 180': '180 يوماً كحد أقصى من البداية (التمديد محظور بعد التعديل)',
        'يمكن تمديد فترة التجربة': 'تمديد فترة التجربة محظور بعد تعديل 2025',
        '90 يوم قابلة للتمديد': '180 يوماً كحد أقصى (التمديد محظور بعد تعديل 2025)',
        'فترة التجربة 3 أشهر': 'فترة التجربة 180 يوماً (6 أشهر) كحد أقصى (المعدلة 2025)',
        'فترة التجربة ثلاثة أشهر': 'فترة التجربة 180 يوماً (6 أشهر) كحد أقصى (المعدلة 2025)',

        # Article 80 - Absence thresholds (AI often confuses warning vs termination)
        'غياب 20 يوم': 'غياب أكثر من 30 يوماً متفرقة أو أكثر من 15 يوماً متصلة (بعد إنذار كتابي عند 20/10)',
        'غياب 20 يوماً متفرقة': 'غياب أكثر من 30 يوماً متفرقة أو أكثر من 15 يوماً متصلة في السنة',
        'غياب 10 أيام متصلة': 'غياب أكثر من 15 يوماً متصلة (الإنذار الكتابي يكون عند 10 أيام)',
        'غياب 10 أيام متتالية': 'غياب أكثر من 15 يوماً متتالية (الإنذار الكتابي عند 10 أيام)',
        'غياب 20 يوم متفرقة أو 10 أيام متصلة': 'غياب أكثر من 30 يوماً متفرقة أو 15 يوماً متصلة (الإنذار عند 20/10)',

        # Article 151 - Maternity leave
        '10 أسابيع': '12 أسبوعاً (المعدلة 2025)',
        'إجازة وضع 10 أسابيع': 'إجازة وضع 12 أسبوعاً (المعدلة بمرسوم م/44)',
        'إجازة وضع 70 يوم': 'إجازة وضع 12 أسبوعاً / 84 يوماً (المعدلة 2025)',
        'إجازة أمومة 10 أسابيع': 'إجازة أمومة 12 أسبوعاً (المعدلة 2025)',

        # Article 116 - Sick leave (AI often assigns wrong article number)
        'المرضية (المادة 113)': 'المرضية (المادة 116)',
        'الإجازة المرضية (م113)': 'الإجازة المرضية (م116)',
        'المرضية وفق المادة 113': 'المرضية وفق المادة 116',
        'إجازة مرضية (المادة 113)': 'إجازة مرضية (المادة 116)',

        # Article 113 - Paternity (AI sometimes gives wrong days)
        'إجازة الأبوة 5 أيام': 'إجازة الأبوة 3 أيام (المادة 113)',
        'إجازة أبوة 5 أيام': 'إجازة أبوة 3 أيام (المادة 113)',

        # Notice period corrections
        'إشعار 30 يوماً': 'إشعار: 60 يوماً من صاحب العمل، 30 يوماً من العامل',
        'إشعار مسبق 30 يوم': 'إشعار مسبق: 60 يوماً من صاحب العمل، 30 يوماً من العامل (المادة 75)',

        # Article 109 - Annual leave
        'إجازة سنوية 30 يوم': 'إجازة سنوية 21 يوماً (أول 5 سنوات) ثم 30 يوماً (المادة 109)',
    }
    ...
    # === Article 77 conditional check ===
    if 'المادة 77' in response or 'مادة 77' in response:
        # Skip if response already says it doesn't apply
        skip_phrases = ['لا تنطبق', 'لا تُطبق', 'لا علاقة', 'لا تسري']
        if not any(p in response for p in skip_phrases):
            # Check if contract clause precedence is mentioned
            clause_phrases = ['ما لم يتضمن العقد', 'تضمّن العقد', 'تضمن العقد', 'يُعمل بالعقد', 'شرط العقد', 'بند تعويض']
            if not any(p in response for p in clause_phrases):
                response += '\n\n**ملاحظة بخصوص المادة 77:** التعويضات تُطبق فقط إذا لم يتضمن العقد شرط تعويض محدد. إذا تضمّن العقد تعويضاً محدداً فيُعمل بالعقد (الأصل).'

    # === Article 81 + Article 77 conflict check ===
    if ('المادة 81' in response or 'م81' in response):
        if ('المادة 77' in response or 'م77' in response):
            # Check if it wrongly applies م77 with م81
            if 'لا تنطبق' not in response and 'لا تسري' not in response:
                if 'ترك العمل' in response or 'يترك' in response or 'ترك العامل' in response:
                    response += '\n\n⚠️ **تنبيه مهم:** المادة 77 (التعويض عن الفصل التعسفي) لا تنطبق مع المادة 81 (ترك العامل بسبب تعدي صاحب العمل). حقوق العامل وفق م81: مكافأة نهاية الخدمة كاملة (م84) + بدل إجازات + تسوية خلال أسبوع (م88).'

    # === Verify article numbers (max 245) ===
    for a in re.findall(r'المادة\s*(\d+)', response):
        num = int(a)
        if num > 245:
            response = response.replace(f'المادة {a}', f'[المادة {a} - رقم غير صحيح، نظام العمل يحتوي 245 مادة فقط]')

    # === GOSI rate corrections ===
    gosi_corrections = {
        'خصم الموظف السعودي: 10.5%': 'خصم الموظف السعودي: 9.75% (قديم) أو 10.25% (جديد)',
        'تحمّل الشركة: 12.5%': 'تحمّل الشركة: 11.75% (قديم) أو 12.25% (جديد)',
        '9.75% على الموظف': '9% معاشات على الموظف (إجمالي مع ساند: 9.75%)',
        'المعاشات: 9.75%': 'المعاشات: 9% (+ ساند 0.75% = إجمالي 9.75%)',
        'نسبة التأمينات 10%': 'نسبة التأمينات: 9.75% (قديم) أو 10.25% (جديد) على الموظف السعودي',
        'نسبة التأمينات 22%': 'نسبة التأمينات: الموظف 9.75% + الشركة 11.75% = 21.5% (قديم)',
    }
    for wrong, correct in gosi_corrections.items():
        if wrong in response:
            response = response.replace(wrong, correct)

    if '10.5%' in response and 'خصم' in response:
        response = response.replace('10.5%', '9.75%')
    if '12.5%' in response and ('شركة' in response or 'صاحب' in response):
        response = response.replace('12.5%', '11.75%')

    # === Paternity leave article fix ===
    if 'إجازة الأبوة' in response or 'إجازة أبوة' in response:
        response = response.replace('المادة 112', 'المادة 113')

    return response

def search_kb(question, kb_dict, max_results=3):
    """Enhanced KB search with morphological matching, synonym expansion, and smart scoring."""
    q = question.lower().strip()
    if not q: return ""

    # Arabic morphological normalization
    def normalize_ar(text):
        t = text.replace('أ','ا').replace('إ','ا').replace('آ','ا').replace('ؤ','و').replace('ئ','ي')
        t = t.replace('ة','ه').replace('ى','ي').replace('ٱ','ا')
    ...
    SYNONYMS = {
        'فصل': ['طرد','إقالة','إنهاء','فسخ','فصلوني','طردوني','فصلني'],
        'راتب': ['أجر','معاش','دخل','مرتب'],
        'إجازة': ['عطلة','راحة','إجازات'],
        'مكافأة': ['مكافاة','مستحقات','حقوق','تعويض'],
        'استقالة': ['أستقيل','ترك','مغادرة','أترك'],
        'عقد': ['عقود','اتفاقية','تعاقد'],
        'تجربة': ['اختبار','تجريبي','اختبارية'],
        'تأمين': ['تأمينات','اشتراك','gosi'],
        'غياب': ['تغيب','انقطاع','عدم حضور','غائب'],
        'تدريب': ['تطوير','تأهيل','دورة','دورات'],
        'شكوى': ['نزاع','خلاف','تظلم','شكاوى'],
        'سعودة': ['توطين','نطاقات','nitaqat'],
        'اعتداء': ['تعدي','ضرب','إهانة','إساءة','تحرش','سب','شتم'],
        'حامل': ['حمل','وضع','أمومة','ولادة'],
        'مرضية': ['مرض','مريض','صحية'],
    }

    q_normalized = normalize_ar(q)

    # Expand question with synonyms
    q_expanded_words = set(q.split())
    for base, syns in SYNONYMS.items():
        if base in q or any(s in q for s in syns):
            q_expanded_words.add(base)
            q_expanded_words.update(syns)

    scored = []
    for pattern_str, answer in kb_dict.items():
        keywords = pattern_str.split("|")
        score = 0
        matched_keywords = 0
        for kw in keywords:
            kw_lower = kw.lower().strip()
            if len(kw_lower) < 2: continue
            kw_normalized = normalize_ar(kw_lower)
            ...
            if kw_lower in q:
                ...
                matched_keywords += 1
            # Normalized match
            elif kw_normalized in q_normalized:
                score += len(kw_lower) * 2.5
                matched_keywords += 1
            # Synonym/expanded match
            elif kw_lower in q_expanded_words:
                score += len(kw_lower) * 2
                matched_keywords += 1
            # Partial root match (3+ chars)
            elif len(kw_lower) >= 3:
                kw_root = kw_normalized[:3] if len(kw_normalized) >= 3 else kw_normalized
                if kw_root in q_normalized and len(kw_root) >= 3:
                    score += len(kw_lower) * 1
                    matched_keywords += 1

        # Bonus for multiple keyword matches (topic relevance)
        ...
        if score > 0:
            scored.append((score, matched_keywords, answer))

    if not scored: return ""

    # Sort by score descending, then by keyword match count
    scored.sort(key=lambda x: (-x[0], -x[1]))

    # Return top matches as reference
    refs = [entry for _, _, entry in scored[:max_results]]
    return "\n\n---\n\n".join(refs)
...
def rate_answer(q_hash, rating, consultant_type):
    """User rates answer: +1 good, -1 bad. Bad answers get saved as corrections."""
    try:
        conn = get_conn(); c = conn.cursor()
        c.execute(f"SELECT value FROM app_config WHERE key = {_ph()}", ("rag_learned",))
        row = c.fetchone()
        if row:
            ...
            for i, item in enumerate(learned):
                if item.get('hash') == q_hash and item.get('type') == consultant_type:
                    ...
                    if new_score <= -2:
                        # Save as BAD example instead of deleting
                        item['bad'] = True
                        learned[i] = item
                    else:
...
def get_learned_context(question, consultant_type="legal", max_examples=3):
    """Retrieve past good/bad answers for similar questions to inject into prompt.
    This is the LEARNING LOOP - past feedback improves future answers."""
    try:
        conn = get_conn(); c = conn.cursor()
        c.execute(f"SELECT value FROM app_config WHERE key = {_ph()}", ("rag_learned",))
        row = c.fetchone(); conn.close()
        ...
        # Score each learned entry by relevance to current question
        scored = []
        for item in learned:
            if item.get('type') != consultant_type: continue
            saved_q = item.get('q', '').lower()
            saved_words = set(saved_q.split())
        ...
        good_examples = []
        bad_examples = []
        for _, item in scored[:max_examples]:
            if item.get('bad'):
                bad_examples.append(f"سؤال: {item['q'][:100]}\nإجابة خاطئة (لا تكررها): {item['a'][:200]}")
            elif item.get('score', 0) > 0:
                good_examples.append(f"سؤال: {item['q'][:100]}\nإجابة جيدة (اتبع هذا النمط): {item['a'][:300]}")

        context = ""
        if bad_examples:
            context += "\n⚠️ إجابات سابقة خاطئة (تعلّم منها ولا تكررها):\n" + "\n---\n".join(bad_examples[:2])
        if good_examples:
            context += "\n✅ إجابات سابقة ممتازة (اتبع نفس المنهج):\n" + "\n---\n".join(good_examples[:2])
        return context
    except:
        return ""
...
""", unsafe_allow_html=True)
        ...
        with forgot_tab:
            ...
            with st.form("forgot_form", clear_on_submit=False):
                ...
                reset_btn = st.form_submit_button("إرسال كلمة مرور مؤقتة", type="primary", use_container_width=True)
...
def main():
    ...
    with st.sidebar:
        ...
        section = st.radio("📂", available_sections, index=_sec_idx, label_visibility="collapsed", key="_nav_section")
        st.markdown("---")

        if section == "📊 التحليلات العامة":
            page = st.radio("📌", ["🏠 نظرة عامة","📊 الأقسام","🤖 المحلل الذكي","📋 البيانات"], label_visibility="collapsed", index=next((i for i,p in enumerate(["🏠 نظرة عامة","📊 الأقسام","🤖 المحلل الذكي","📋 البيانات"]) if p==_saved_pg),0) if _saved_sec==section else 0, key="_nav_p_analytics")
        elif section == "🎁 Total Rewards":
            page = st.radio("📌", ["🎁 لوحة Total Rewards","💰 لوحة الرواتب","📈 تحليل شهري/ربعي","🏷️ تحليل حسب الفئات","📊 سلم الرواتب","💰 هيكل الرواتب","🏥 المزايا والتأمينات","📊 تحليل التنافسية","📥 تصدير TR"], label_visibility="collapsed", index=next((i for i,p in enumerate(["🎁 لوحة Total Rewards","💰 لوحة الرواتب","📈 تحليل شهري/ربعي","🏷️ تحليل حسب الفئات","📊 سلم الرواتب","💰 هيكل الرواتب","🏥 المزايا والتأمينات","📊 تحليل التنافسية","📥 تصدير TR"]) if p==_saved_pg),0) if _saved_sec==section else 0, key="_nav_p_tr")
        elif section == "👥 Headcount":
            page = st.radio("📌", ["👥 Headcount Report","📊 تحليل الأداء","🚪 تحليل المغادرين","🗄️ قاعدة بيانات الموظفين","📋 بيانات الموظفين","📥 تصدير Headcount"], label_visibility="collapsed", index=next((i for i,p in enumerate(["👥 Headcount Report","📊 تحليل الأداء","🚪 تحليل المغادرين","🗄️ قاعدة بيانات الموظفين","📋 بيانات الموظفين","📥 تصدير Headcount"]) if p==_saved_pg),0) if _saved_sec==section else 0, key="_nav_p_hc")
        elif section == "⚖️ حاسبة المستحقات":
            page = "⚖️ حاسبة المستحقات"
        elif section == "🎯 التوظيف":
            page = st.radio("📌", ["📋 تخطيط التوظيف","🤖 Benchmark ذكاء اصطناعي","🌍 مقارنة الأسواق","📊 متابعة التوظيف","📄 تحليل السير الذاتية","🎤 تحليل المقابلات","📋 ATS تتبع المتقدمين","📥 تصدير التوظيف"], label_visibility="collapsed", index=next((i for i,p in enumerate(["📋 تخطيط التوظيف","🤖 Benchmark ذكاء اصطناعي","🌍 مقارنة الأسواق","📊 متابعة التوظيف","📄 تحليل السير الذاتية","🎤 تحليل المقابلات","📋 ATS تتبع المتقدمين","📥 تصدير التوظيف"]) if p==_saved_pg),0) if _saved_sec==section else 0, key="_nav_p_recruit")
        elif section == "🚀 Onboarding":
            page = st.radio("📌", ["🚀 إنشاء Onboarding","📋 خطة 30/60/90","👥 متابعة الموظفين الجدد","📊 تحليلات Onboarding","🎬 عرض تقديمي AI","🏢 معلومات الشركة","📥 تصدير Onboarding"], label_visibility="collapsed", index=next((i for i,p in enumerate(["🚀 إنشاء Onboarding","📋 خطة 30/60/90","👥 متابعة الموظفين الجدد","📊 تحليلات Onboarding","🎬 عرض تقديمي AI","🏢 معلومات الشركة","📥 تصدير Onboarding"]) if p==_saved_pg),0) if _saved_sec==section else 0, key="_nav_p_onboard")
        elif section == "📜 العقود":
            page = st.radio("📌", ["📜 إنشاء عقد","🔍 تحليل العقود","📋 العقود المحفوظة","📥 تصدير العقود"], label_visibility="collapsed", index=next((i for i,p in enumerate(["📜 إنشاء عقد","🔍 تحليل العقود","📋 العقود المحفوظة","📥 تصدير العقود"]) if p==_saved_pg),0) if _saved_sec==section else 0, key="_nav_p_contracts")
        elif section == "🤖 المستشار الذكي":
            page = st.radio("📌", ["⚖️ المستشار القانوني","📚 مستشار الموارد البشرية","🧠 قاعدة المعرفة RAG","📊 التعلم والتحسين","📋 إدارة المراجع"], label_visibility="collapsed", index=next((i for i,p in enumerate(["⚖️ المستشار القانوني","📚 مستشار الموارد البشرية","🧠 قاعدة المعرفة RAG","📊 التعلم والتحسين","📋 إدارة المراجع"]) if p==_saved_pg),0) if _saved_sec==section else 0, key="_nav_p_advisor")
        elif section == "🏗️ التطوير المؤسسي OD":
            page = st.radio("📌", ["🔍 تشخيص المنظمة","📊 تحليل OD","🎯 استراتيجية OD","📋 خطة التنفيذ","📥 تصدير OD"], label_visibility="collapsed", index=next((i for i,p in enumerate(["🔍 تشخيص المنظمة","📊 تحليل OD","🎯 استراتيجية OD","📋 خطة التنفيذ","📥 تصدير OD"]) if p==_saved_pg),0) if _saved_sec==section else 0, key="_nav_p_od")
        elif section == "📈 التحليلات المتقدمة":
            page = st.radio("📌", ["📊 مؤشرات HR المتقدمة","🔔 التنبيهات الذكية","🔮 سيناريوهات What-If","🤖 التحليل التنبؤي","💬 تحليل المشاعر","📋 سجل التدقيق"], label_visibility="collapsed", index=next((i for i,p in enumerate(["📊 مؤشرات HR المتقدمة","🔔 التنبيهات الذكية","🔮 سيناريوهات What-If","🤖 التحليل التنبؤي","💬 تحليل المشاعر","📋 سجل التدقيق"]) if p==_saved_pg),0) if _saved_sec==section else 0, key="_nav_p_advanced")
        elif section == "🔍 التحليل العام":
            page = st.radio("📌", ["📊 تحليل تلقائي","🤖 أسئلة ذكية"], label_visibility="collapsed", index=next((i for i,p in enumerate(["📊 تحليل تلقائي","🤖 أسئلة ذكية"]) if p==_saved_pg),0) if _saved_sec==section else 0, key="_nav_p_general")
        elif section == "📝 الاستبيانات":
            page = st.radio("📌", ["📋 قوالب جاهزة","🔨 بناء استبيان","📊 تحليل النتائج","📥 تصدير الاستبيانات"], label_visibility="collapsed", index=next((i for i,p in enumerate(["📋 قوالب جاهزة","🔨 بناء استبيان","📊 تحليل النتائج","📥 تصدير الاستبيانات"]) if p==_saved_pg),0) if _saved_sec==section else 0, key="_nav_p_surveys")
        elif section == "🧠 اختبارات الشخصية":
            page = st.radio("📌", ["📋 تعيين الاختبارات","🧠 Big Five (OCEAN)","📊 Thomas PPA","🔬 Hogan HPI","💡 MBTI","💎 DISC","📈 تقارير الشخصية","📥 تصدير الاختبارات"], label_visibility="collapsed", index=next((i for i,p in enumerate(["📋 تعيين الاختبارات","🧠 Big Five (OCEAN)","📊 Thomas PPA","🔬 Hogan HPI","💡 MBTI","💎 DISC","📈 تقارير الشخصية","📥 تصدير الاختبارات"]) if p==_saved_pg),0) if _saved_sec==section else 0, key="_nav_p_tests")
        elif section == "📤 التقارير والتصدير":
            page = st.radio("📌", ["📊 تقرير Dashboard","📝 تقرير Word","📊 تقرير شامل"], label_visibility="collapsed", index=next((i for i,p in enumerate(["📊 تقرير Dashboard","📝 تقرير Word","📊 تقرير شامل"]) if p==_saved_pg),0) if _saved_sec==section else 0, key="_nav_p_reports")
...
3. **لا يقل التعويض في كلا الحالتين عن أجر شهرين**""")
        ...
        st.markdown("""
<div style='background:#FEF2F2;border:1px solid #EF4444;border-radius:10px;padding:14px;margin:8px 0;font-size:13px;line-height:1.9'>
⚠️ <b>تنبيهات مهمة حول تطبيق المادة 77:</b><br>
1. <b>الإنهاء بموجب المادة 75 (بإشعار نظامي):</b> إذا أنهى صاحب العمل العقد غير المحدد بإشعار مسبق (60 يوماً) وفق المادة 75، <b>لا يُعدّ ذلك فصلاً تعسفياً ولا يستحق العامل تعويض المادة 77</b>. يستحق فقط: مكافأة نهاية الخدمة (م84) + بدل الإجازات + الأجر حتى نهاية فترة الإشعار.<br>
2. <b>المادة 77 تُطبّق فقط</b> عند الإنهاء لسبب غير مشروع (فصل تعسفي) بدون مبرر قانوني.<br>
3. <b>المادة 80 (فصل مشروع):</b> لا يستحق العامل مكافأة ولا تعويض (اعتداء، إخلال جسيم، غياب متكرر...).<br>
4. <b>المادة 81 (ترك العامل بسبب تعدي صاحب العمل):</b> يستحق مكافأة كاملة (م84) + إجازات + تسوية (م88)، <b>وليس تعويض م77</b>.
</div>
""", unsafe_allow_html=True)
...
""", unsafe_allow_html=True)
            ...
            # =====================================================
            # ⚠️ MINISTERIAL DECISIONS & MINIMUM WAGE NOTICE
            # =====================================================
            if "السعودية" in bm_country:
                st.markdown("---")
                st.markdown("### ⚠️ تنبيه: الحدود الدنيا للأجور والقرارات الوزارية")
                st.markdown("""
...
**📋 بعض المهن والمستويات الوظيفية لها حدود دنيا للأجور منصوص عليها في قرارات وزارية. يجب الرجوع إليها عند التوظيف:**
...
- المستوى التشغيلي والحرفي: حد أدنى **5,000** ريال
- وظائف الإدارة العليا: حد أدنى معادلة **8,400 + 600** ريال
- القطاع الحكومي: الحد الأدنى **3,000** ريال

**🏢 مهن التوطين الإلزامي:**
- خدمة العملاء: توطين بنسبة **100%**
- مهن المبيعات (أخصائي تسويق، مندوب مبيعات): توطين بنسبة **40%**
- المهن المساندة: قرارات توطين خاصة

**📌 المهن المستثناة:** عمال النظافة والشحن والتفريغ (بنسبة لا تزيد عن 20%)

</div>
""", unsafe_allow_html=True)

                st.markdown("#### 🔗 روابط مهمة للاطلاع على القرارات الوزارية:")
                link_data = [
                    ("🏛️ وزارة الموارد البشرية والتنمية الاجتماعية", "https://hrsd.gov.sa", "الموقع الرسمي - القرارات والتعاميم"),
                    ("📋 بوابة نطاقات المطوّر", "https://www.mol.gov.sa/Nitaqat", "تفاصيل نسب التوطين لكل نشاط وحجم"),
                    ("💼 منصة قوى", "https://qiwa.sa", "إدارة العلاقة التعاقدية والتنقل الوظيفي"),
                    ("📊 المرصد الوطني للعمل", "https://lmi.sa", "بيانات سوق العمل والرواتب والمهن"),
                    ("🔍 المصنّف السعودي الموحّد للمهن", "https://hrsd.gov.sa/ar/ministerial-decisions", "القرارات الوزارية لتوطين المهن"),
                    ("📈 الهيئة العامة للإحصاء", "https://www.stats.gov.sa", "إحصاءات سوق العمل والأجور"),
                    ("🏦 التأمينات الاجتماعية", "https://www.gosi.gov.sa", "نسب الاشتراكات والأجور المسجلة"),
                ]
                for icon_name, url, desc in link_data:
                    st.markdown(f"- [{icon_name}]({url}) — {desc}")

                ibox("**💡 نصيحة:** قبل تحديد راتب أي وظيفة، تحقق من القرارات الوزارية المحدّثة عبر الروابط أعلاه. الحدود الدنيا تتغير بقرارات وزارية دورية وقد لا تنعكس فوراً في مصادر الرواتب الإلكترونية.", "warning")
        ...
        # ===== Global Salary Intelligence =====
            ...
            # === Country Database ===
            COUNTRIES = {
                "🇸🇦 السعودية":{"code":"SA","currency":"SAR","to_sar":1.0,"region":"الخليج","min_wage":"4,000 SAR"},
                "🇦🇪 الإمارات":{"code":"AE","currency":"AED","to_sar":1.02,"region":"الخليج","min_wage":"لا يوجد"},
                ...
                "🇧🇭 البحرين":{"code":"BH","currency":"BHD","to_sar":9.95,"region":"الخليج","min_wage":"300 BHD"},
                "🇴🇲 عُمان":{"code":"OM","currency":"OMR","to_sar":9.74,"region":"الخليج","min_wage":"325 OMR"},
                ...
                "🇱🇧 لبنان":{"code":"LB","currency":"USD","to_sar":3.75,"region":"بلاد الشام","min_wage":"~450 USD"},
                "🇮🇶 العراق":{"code":"IQ","currency":"IQD","to_sar":0.0029,"region":"بلاد الشام","min_wage":"350K IQD"},
                "🇸🇾 سوريا":{"code":"SY","currency":"SYP","to_sar":0.00015,"region":"بلاد الشام","min_wage":"185K SYP"},
                "🇵🇸 فلسطين":{"code":"PS","currency":"ILS","to_sar":1.03,"region":"بلاد الشام","min_wage":"1,880 ILS"},
                "🇾🇪 اليمن":{"code":"YE","currency":"YER","to_sar":0.015,"region":"شبه الجزيرة","min_wage":"21K YER"},
                "🇮🇷 إيران":{"code":"IR","currency":"IRR","to_sar":8.9e-05,"region":"غرب آسيا","min_wage":"~230M IRR"},
                "🇹🇷 تركيا":{"code":"TR","currency":"TRY","to_sar":0.11,"region":"أوروبا/آسيا","min_wage":"20K TRY"},
                "🇨🇾 قبرص":{"code":"CY","currency":"EUR","to_sar":4.05,"region":"أوروبا","min_wage":"€940"},
                ...
                "🇩🇿 الجزائر":{"code":"DZ","currency":"DZD","to_sar":0.028,"region":"شمال أفريقيا","min_wage":"20K DZD"},
                "🇱🇾 ليبيا":{"code":"LY","currency":"LYD","to_sar":0.78,"region":"شمال أفريقيا","min_wage":"450 LYD"},
                "🇸🇩 السودان":{"code":"SD","currency":"SDG","to_sar":0.006,"region":"شمال أفريقيا","min_wage":"~3K SDG"},
                "🇲🇷 موريتانيا":{"code":"MR","currency":"MRU","to_sar":0.094,"region":"غرب أفريقيا","min_wage":"~3K MRU"},
                "🇮🇳 الهند":{"code":"IN","currency":"INR","to_sar":0.045,"region":"جنوب آسيا","min_wage":"يختلف"},
                "🇵🇰 باكستان":{"code":"PK","currency":"PKR","to_sar":0.013,"region":"جنوب آسيا","min_wage":"32K PKR"},
                "🇧🇩 بنغلاديش":{"code":"BD","currency":"BDT","to_sar":0.031,"region":"جنوب آسيا","min_wage":"12.5K BDT"},
                "🇱🇰 سريلانكا":{"code":"LK","currency":"LKR","to_sar":0.012,"region":"جنوب آسيا","min_wage":"12.5K LKR"},
                "🇳🇵 نيبال":{"code":"NP","currency":"NPR","to_sar":0.028,"region":"جنوب آسيا","min_wage":"17.3K NPR"},
                "🇦🇫 أفغانستان":{"code":"AF","currency":"AFN","to_sar":0.054,"region":"جنوب آسيا","min_wage":"5K AFN"},
                "🇲🇻 المالديف":{"code":"MV","currency":"MVR","to_sar":0.24,"region":"جنوب آسيا","min_wage":"~8K MVR"},
                "🇧🇹 بوتان":{"code":"BT","currency":"BTN","to_sar":0.045,"region":"جنوب آسيا","min_wage":"~4K BTN"},
                "🇵🇭 الفلبين":{"code":"PH","currency":"PHP","to_sar":0.067,"region":"جنوب شرق آسيا","min_wage":"610 PHP/يوم"},
                "🇮🇩 إندونيسيا":{"code":"ID","currency":"IDR","to_sar":0.00024,"region":"جنوب شرق آسيا","min_wage":"يختلف"},
                "🇸🇬 سنغافورة":{"code":"SG","currency":"SGD","to_sar":2.8,"region":"جنوب شرق آسيا","min_wage":"لا يوجد"},
                "🇲🇾 ماليزيا":{"code":"MY","currency":"MYR","to_sar":0.85,"region":"جنوب شرق آسيا","min_wage":"1,500 MYR"},
                "🇹🇭 تايلاند":{"code":"TH","currency":"THB","to_sar":0.11,"region":"جنوب شرق آسيا","min_wage":"~370 THB/يوم"},
                "🇻🇳 فيتنام":{"code":"VN","currency":"VND","to_sar":0.00015,"region":"جنوب شرق آسيا","min_wage":"~4.7M VND"},
                "🇲🇲 ميانمار":{"code":"MM","currency":"MMK","to_sar":0.0018,"region":"جنوب شرق آسيا","min_wage":"4,800 MMK/يوم"},
                "🇰🇭 كمبوديا":{"code":"KH","currency":"USD","to_sar":3.75,"region":"جنوب شرق آسيا","min_wage":"200 USD"},
                "🇱🇦 لاوس":{"code":"LA","currency":"LAK","to_sar":0.00017,"region":"جنوب شرق آسيا","min_wage":"1.6M LAK"},
                "🇧🇳 بروناي":{"code":"BN","currency":"BND","to_sar":2.8,"region":"جنوب شرق آسيا","min_wage":"لا يوجد"},
                "🇹🇱 تيمور الشرقية":{"code":"TL","currency":"USD","to_sar":3.75,"region":"جنوب شرق آسيا","min_wage":"115 USD"},
                "🇨🇳 الصين":{"code":"CN","currency":"CNY","to_sar":0.52,"region":"شرق آسيا","min_wage":"يختلف"},
                ...
                "🇹🇼 تايوان":{"code":"TW","currency":"TWD","to_sar":0.12,"region":"شرق آسيا","min_wage":"27,470 TWD"},
                "🇭🇰 هونغ كونغ":{"code":"HK","currency":"HKD","to_sar":0.48,"region":"شرق آسيا","min_wage":"40 HKD/ساعة"},
                "🇲🇳 منغوليا":{"code":"MN","currency":"MNT","to_sar":0.0011,"region":"شرق آسيا","min_wage":"550K MNT"},
                "🇰🇵 كوريا الشمالية":{"code":"KP","currency":"KPW","to_sar":0.0042,"region":"شرق آسيا","min_wage":"غير متاح"},
                ...
                "🇮🇹 إيطاليا":{"code":"IT","currency":"EUR","to_sar":4.05,"region":"أوروبا","min_wage":"لا يوجد"},
                "🇪🇸 إسبانيا":{"code":"ES","currency":"EUR","to_sar":4.05,"region":"أوروبا","min_wage":"€1,134/شهر"},
                "🇳🇱 هولندا":{"code":"NL","currency":"EUR","to_sar":4.05,"region":"أوروبا","min_wage":"€1,995/شهر"},
                "🇧🇪 بلجيكا":{"code":"BE","currency":"EUR","to_sar":4.05,"region":"أوروبا","min_wage":"€1,994/شهر"},
                "🇨🇭 سويسرا":{"code":"CH","currency":"CHF","to_sar":4.25,"region":"أوروبا","min_wage":"لا يوجد فيدرالي"},
                "🇦🇹 النمسا":{"code":"AT","currency":"EUR","to_sar":4.05,"region":"أوروبا","min_wage":"لا يوجد"},
                "🇸🇪 السويد":{"code":"SE","currency":"SEK","to_sar":0.36,"region":"أوروبا","min_wage":"لا يوجد"},
                "🇳🇴 النرويج":{"code":"NO","currency":"NOK","to_sar":0.35,"region":"أوروبا","min_wage":"لا يوجد"},
                "🇩🇰 الدنمارك":{"code":"DK","currency":"DKK","to_sar":0.54,"region":"أوروبا","min_wage":"لا يوجد"},
                "🇫🇮 فنلندا":{"code":"FI","currency":"EUR","to_sar":4.05,"region":"أوروبا","min_wage":"لا يوجد"},
                "🇮🇪 أيرلندا":{"code":"IE","currency":"EUR","to_sar":4.05,"region":"أوروبا","min_wage":"€12.70/ساعة"},
                "🇵🇹 البرتغال":{"code":"PT","currency":"EUR","to_sar":4.05,"region":"أوروبا","min_wage":"€820/شهر"},
                "🇬🇷 اليونان":{"code":"GR","currency":"EUR","to_sar":4.05,"region":"أوروبا","min_wage":"€780/شهر"},
                "🇱🇺 لوكسمبورغ":{"code":"LU","currency":"EUR","to_sar":4.05,"region":"أوروبا","min_wage":"€2,571/شهر"},
                "🇮🇸 آيسلندا":{"code":"IS","currency":"ISK","to_sar":0.027,"region":"أوروبا","min_wage":"~410K ISK"},
                "🇲🇹 مالطا":{"code":"MT","currency":"EUR","to_sar":4.05,"region":"أوروبا","min_wage":"€835/شهر"},
                "🇵🇱 بولندا":{"code":"PL","currency":"PLN","to_sar":0.94,"region":"أوروبا الشرقية","min_wage":"4,300 PLN"},
                "🇷🇴 رومانيا":{"code":"RO","currency":"RON","to_sar":0.81,"region":"أوروبا الشرقية","min_wage":"3,300 RON"},
                "🇨🇿 التشيك":{"code":"CZ","currency":"CZK","to_sar":0.17,"region":"أوروبا الشرقية","min_wage":"18,900 CZK"},
                "🇭🇺 المجر":{"code":"HU","currency":"HUF","to_sar":0.011,"region":"أوروبا الشرقية","min_wage":"266K HUF"},
                "🇺🇦 أوكرانيا":{"code":"UA","currency":"UAH","to_sar":0.091,"region":"أوروبا الشرقية","min_wage":"8K UAH"},
                "🇷🇺 روسيا":{"code":"RU","currency":"RUB","to_sar":0.043,"region":"أوروبا/آسيا","min_wage":"19,242 RUB"},
                "🇧🇬 بلغاريا":{"code":"BG","currency":"BGN","to_sar":2.07,"region":"أوروبا الشرقية","min_wage":"933 BGN"},
                "🇭🇷 كرواتيا":{"code":"HR","currency":"EUR","to_sar":4.05,"region":"أوروبا الشرقية","min_wage":"€740/شهر"},
                "🇷🇸 صربيا":{"code":"RS","currency":"RSD","to_sar":0.037,"region":"أوروبا الشرقية","min_wage":"47K RSD"},
                "🇸🇰 سلوفاكيا":{"code":"SK","currency":"EUR","to_sar":4.05,"region":"أوروبا الشرقية","min_wage":"€700/شهر"},
                "🇸🇮 سلوفينيا":{"code":"SI","currency":"EUR","to_sar":4.05,"region":"أوروبا الشرقية","min_wage":"€1,203/شهر"},
                "🇱🇹 ليتوانيا":{"code":"LT","currency":"EUR","to_sar":4.05,"region":"أوروبا الشرقية","min_wage":"€924/شهر"},
                "🇱🇻 لاتفيا":{"code":"LV","currency":"EUR","to_sar":4.05,"region":"أوروبا الشرقية","min_wage":"€700/شهر"},
                "🇪🇪 إستونيا":{"code":"EE","currency":"EUR","to_sar":4.05,"region":"أوروبا الشرقية","min_wage":"€820/شهر"},
                "🇧🇦 البوسنة":{"code":"BA","currency":"BAM","to_sar":2.07,"region":"أوروبا الشرقية","min_wage":"520 BAM"},
                "🇦🇱 ألبانيا":{"code":"AL","currency":"ALL","to_sar":0.038,"region":"أوروبا الشرقية","min_wage":"40K ALL"},
                "🇲🇰 مقدونيا":{"code":"MK","currency":"MKD","to_sar":0.066,"region":"أوروبا الشرقية","min_wage":"~20K MKD"},
                "🇲🇩 مولدوفا":{"code":"MD","currency":"MDL","to_sar":0.21,"region":"أوروبا الشرقية","min_wage":"~5K MDL"},
                "🇧🇾 بيلاروسيا":{"code":"BY","currency":"BYN","to_sar":1.15,"region":"أوروبا الشرقية","min_wage":"~626 BYN"},
                "🇽🇰 كوسوفو":{"code":"XK","currency":"EUR","to_sar":4.05,"region":"أوروبا الشرقية","min_wage":"€264/شهر"},
                "🇲🇪 الجبل الأسود":{"code":"ME","currency":"EUR","to_sar":4.05,"region":"أوروبا الشرقية","min_wage":"€450/شهر"},
                "🇺🇸 أمريكا":{"code":"US","currency":"USD","to_sar":3.75,"region":"أمريكا الشمالية","min_wage":"$7.25/ساعة"},
                "🇨🇦 كندا":{"code":"CA","currency":"CAD","to_sar":2.75,"region":"أمريكا الشمالية","min_wage":"C$17.30/ساعة"},
                "🇲🇽 المكسيك":{"code":"MX","currency":"MXN","to_sar":0.22,"region":"أمريكا الشمالية","min_wage":"~375 MXN/يوم"},
                "🇨🇺 كوبا":{"code":"CU","currency":"CUP","to_sar":0.16,"region":"الكاريبي","min_wage":"2,100 CUP"},
                "🇯🇲 جامايكا":{"code":"JM","currency":"JMD","to_sar":0.024,"region":"الكاريبي","min_wage":"~13K JMD/أسبوع"},
                "🇩🇴 الدومينيكان":{"code":"DO","currency":"DOP","to_sar":0.063,"region":"الكاريبي","min_wage":"~21K DOP"},
                "🇭🇹 هايتي":{"code":"HT","currency":"HTG","to_sar":0.028,"region":"الكاريبي","min_wage":"~685 HTG/يوم"},
                "🇹🇹 ترينيداد":{"code":"TT","currency":"TTD","to_sar":0.55,"region":"الكاريبي","min_wage":"~17.5 TTD/ساعة"},
                "🇵🇦 بنما":{"code":"PA","currency":"USD","to_sar":3.75,"region":"أمريكا الوسطى","min_wage":"326 USD"},
                "🇨🇷 كوستاريكا":{"code":"CR","currency":"CRC","to_sar":0.0073,"region":"أمريكا الوسطى","min_wage":"~350K CRC"},
                "🇬🇹 غواتيمالا":{"code":"GT","currency":"GTQ","to_sar":0.48,"region":"أمريكا الوسطى","min_wage":"~3.3K GTQ"},
                "🇧🇷 البرازيل":{"code":"BR","currency":"BRL","to_sar":0.66,"region":"أمريكا الجنوبية","min_wage":"1,412 BRL"},
                "🇦🇷 الأرجنتين":{"code":"AR","currency":"ARS","to_sar":0.0044,"region":"أمريكا الجنوبية","min_wage":"~252K ARS"},
                "🇨🇱 تشيلي":{"code":"CL","currency":"CLP","to_sar":0.004,"region":"أمريكا الجنوبية","min_wage":"460K CLP"},
                "🇨🇴 كولومبيا":{"code":"CO","currency":"COP","to_sar":0.00094,"region":"أمريكا الجنوبية","min_wage":"1.3M COP"},
                "🇵🇪 بيرو":{"code":"PE","currency":"PEN","to_sar":1.0,"region":"أمريكا الجنوبية","min_wage":"1,025 PEN"},
                "🇪🇨 الإكوادور":{"code":"EC","currency":"USD","to_sar":3.75,"region":"أمريكا الجنوبية","min_wage":"460 USD"},
                "🇺🇾 أوروغواي":{"code":"UY","currency":"UYU","to_sar":0.094,"region":"أمريكا الجنوبية","min_wage":"22.3K UYU"},
                "🇻🇪 فنزويلا":{"code":"VE","currency":"USD","to_sar":3.75,"region":"أمريكا الجنوبية","min_wage":"~130 USD"},
                "🇧🇴 بوليفيا":{"code":"BO","currency":"BOB","to_sar":0.54,"region":"أمريكا الجنوبية","min_wage":"2,362 BOB"},
                "🇵🇾 باراغواي":{"code":"PY","currency":"PYG","to_sar":0.00051,"region":"أمريكا الجنوبية","min_wage":"~2.7M PYG"},
                "🇳🇬 نيجيريا":{"code":"NG","currency":"NGN","to_sar":0.0024,"region":"غرب أفريقيا","min_wage":"70K NGN"},
                "🇬🇭 غانا":{"code":"GH","currency":"GHS","to_sar":0.24,"region":"غرب أفريقيا","min_wage":"~530 GHS"},
                "🇸🇳 السنغال":{"code":"SN","currency":"XOF","to_sar":0.0062,"region":"غرب أفريقيا","min_wage":"~58K XOF"},
                "🇨🇮 ساحل العاج":{"code":"CI","currency":"XOF","to_sar":0.0062,"region":"غرب أفريقيا","min_wage":"~75K XOF"},
                "🇨🇲 الكاميرون":{"code":"CM","currency":"XAF","to_sar":0.0062,"region":"وسط أفريقيا","min_wage":"~41K XAF"},
                "🇲🇱 مالي":{"code":"ML","currency":"XOF","to_sar":0.0062,"region":"غرب أفريقيا","min_wage":"~40K XOF"},
                "🇧🇫 بوركينا فاسو":{"code":"BF","currency":"XOF","to_sar":0.0062,"region":"غرب أفريقيا","min_wage":"~35K XOF"},
                "🇳🇪 النيجر":{"code":"NE","currency":"XOF","to_sar":0.0062,"region":"غرب أفريقيا","min_wage":"~30K XOF"},
                "🇬🇳 غينيا":{"code":"GN","currency":"GNF","to_sar":0.00044,"region":"غرب أفريقيا","min_wage":"~440K GNF"},
                "🇹🇬 توغو":{"code":"TG","currency":"XOF","to_sar":0.0062,"region":"غرب أفريقيا","min_wage":"~35K XOF"},
                "🇧🇯 بنين":{"code":"BJ","currency":"XOF","to_sar":0.0062,"region":"غرب أفريقيا","min_wage":"~40K XOF"},
                "🇸🇱 سيراليون":{"code":"SL","currency":"SLE","to_sar":0.17,"region":"غرب أفريقيا","min_wage":"~800 SLE"},
                "🇰🇪 كينيا":{"code":"KE","currency":"KES","to_sar":0.029,"region":"شرق أفريقيا","min_wage":"~15K KES"},
                "🇪🇹 إثيوبيا":{"code":"ET","currency":"ETB","to_sar":0.032,"region":"شرق أفريقيا","min_wage":"لا يوجد"},
                "🇹🇿 تنزانيا":{"code":"TZ","currency":"TZS","to_sar":0.0015,"region":"شرق أفريقيا","min_wage":"~400K TZS"},
                "🇺🇬 أوغندا":{"code":"UG","currency":"UGX","to_sar":0.001,"region":"شرق أفريقيا","min_wage":"~6K UGX/يوم"},
                "🇷🇼 رواندا":{"code":"RW","currency":"RWF","to_sar":0.0028,"region":"شرق أفريقيا","min_wage":"لا يوجد"},
                "🇲🇬 مدغشقر":{"code":"MG","currency":"MGA","to_sar":0.00083,"region":"شرق أفريقيا","min_wage":"~250K MGA"},
                "🇸🇴 الصومال":{"code":"SO","currency":"SOS","to_sar":0.0066,"region":"شرق أفريقيا","min_wage":"لا يوجد"},
                "🇩🇯 جيبوتي":{"code":"DJ","currency":"DJF","to_sar":0.021,"region":"شرق أفريقيا","min_wage":"~35K DJF"},
                "🇪🇷 إريتريا":{"code":"ER","currency":"ERN","to_sar":0.25,"region":"شرق أفريقيا","min_wage":"~800 ERN"},
                "🇲🇼 مالاوي":{"code":"MW","currency":"MWK","to_sar":0.0022,"region":"شرق أفريقيا","min_wage":"~50K MWK"},
                "🇿🇦 جنوب أفريقيا":{"code":"ZA","currency":"ZAR","to_sar":0.21,"region":"جنوب أفريقيا","min_wage":"27.58 ZAR/ساعة"},
                "🇲🇺 موريشيوس":{"code":"MU","currency":"MUR","to_sar":0.083,"region":"جنوب أفريقيا","min_wage":"~15K MUR"},
                "🇧🇼 بوتسوانا":{"code":"BW","currency":"BWP","to_sar":0.28,"region":"جنوب أفريقيا","min_wage":"~1.5K BWP"},
                "🇲🇿 موزمبيق":{"code":"MZ","currency":"MZN","to_sar":0.059,"region":"جنوب أفريقيا","min_wage":"~5.5K MZN"},
                "🇿🇲 زامبيا":{"code":"ZM","currency":"ZMW","to_sar":0.14,"region":"جنوب أفريقيا","min_wage":"~1.7K ZMW"},
                "🇿🇼 زيمبابوي":{"code":"ZW","currency":"USD","to_sar":3.75,"region":"جنوب أفريقيا","min_wage":"~250 USD"},
                "🇳🇦 ناميبيا":{"code":"NA","currency":"NAD","to_sar":0.21,"region":"جنوب أفريقيا","min_wage":"لا يوجد"},
                "🇨🇩 الكونغو الديمقراطية":{"code":"CD","currency":"CDF","to_sar":0.0014,"region":"وسط أفريقيا","min_wage":"~1.7M CDF"},
                "🇨🇬 الكونغو":{"code":"CG","currency":"XAF","to_sar":0.0062,"region":"وسط أفريقيا","min_wage":"~50K XAF"},
                "🇬🇦 الغابون":{"code":"GA","currency":"XAF","to_sar":0.0062,"region":"وسط أفريقيا","min_wage":"~150K XAF"},
                "🇹🇩 تشاد":{"code":"TD","currency":"XAF","to_sar":0.0062,"region":"وسط أفريقيا","min_wage":"~60K XAF"},
                "🇬🇶 غينيا الاستوائية":{"code":"GQ","currency":"XAF","to_sar":0.0062,"region":"وسط أفريقيا","min_wage":"~130K XAF"},
                "🇪🇭 الصحراء الغربية":{"code":"EH","currency":"MAD","to_sar":0.38,"region":"شمال أفريقيا","min_wage":"~3K MAD"},
                "🇦🇺 أستراليا":{"code":"AU","currency":"AUD","to_sar":2.45,"region":"أوقيانوسيا","min_wage":"A$23.23/ساعة"},
                "🇳🇿 نيوزيلندا":{"code":"NZ","currency":"NZD","to_sar":2.25,"region":"أوقيانوسيا","min_wage":"NZ$23.15/ساعة"},
                "🇫🇯 فيجي":{"code":"FJ","currency":"FJD","to_sar":1.68,"region":"أوقيانوسيا","min_wage":"~4 FJD/ساعة"},
                "🇵🇬 بابوا غينيا":{"code":"PG","currency":"PGK","to_sar":0.96,"region":"أوقيانوسيا","min_wage":"~3.5 PGK/ساعة"},
                "🇰🇿 كازاخستان":{"code":"KZ","currency":"KZT","to_sar":0.0078,"region":"آسيا الوسطى","min_wage":"85K KZT"},
                "🇺🇿 أوزبكستان":{"code":"UZ","currency":"UZS","to_sar":0.00029,"region":"آسيا الوسطى","min_wage":"~1.1M UZS"},
                "🇬🇪 جورجيا":{"code":"GE","currency":"GEL","to_sar":1.37,"region":"القوقاز","min_wage":"لا يوجد عام"},
                "🇦🇿 أذربيجان":{"code":"AZ","currency":"AZN","to_sar":2.21,"region":"القوقاز","min_wage":"345 AZN"},
                "🇦🇲 أرمينيا":{"code":"AM","currency":"AMD","to_sar":0.0097,"region":"القوقاز","min_wage":"~75K AMD"},
                "🇹🇲 تركمانستان":{"code":"TM","currency":"TMT","to_sar":1.07,"region":"آسيا الوسطى","min_wage":"~1K TMT"},
                "🇹🇯 طاجيكستان":{"code":"TJ","currency":"TJS","to_sar":0.34,"region":"آسيا الوسطى","min_wage":"~600 TJS"},
                "🇰🇬 قيرغيزستان":{"code":"KG","currency":"KGS","to_sar":0.043,"region":"آسيا الوسطى","min_wage":"~1.8K KGS"},
            }

            # Job Categories
            JOB_CATEGORIES = {
                "الموارد البشرية": ["مدير موارد بشرية","نائب رئيس HR","أخصائي موارد بشرية","أخصائي توظيف","أخصائي رواتب","مدير التدريب","أخصائي شؤون موظفين","محلل بيانات HR","مدير التعويضات والمزايا","أخصائي علاقات موظفين","منسق موارد بشرية"],
                "تقنية المعلومات": ["CTO مدير تقني","مدير تقنية المعلومات","مطور برمجيات","مطور Full-Stack","مطور واجهات أمامية","مطور خلفية","محلل بيانات","عالم بيانات","مهندس DevOps","مهندس Cloud","أخصائي أمن سيبراني","مدير مشاريع تقنية","مهندس شبكات","مسؤول أنظمة","مهندس QA","مصمم قواعد بيانات","مطور تطبيقات موبايل","مهندس AI/ML"],
                "المالية والمحاسبة": ["CFO مدير مالي","مدير مالي","محاسب عام","محاسب تكاليف","مدقق داخلي","محلل مالي","أخصائي ضريبة","مدير خزينة","محاسب رواتب","مراقب مالي","أخصائي ميزانية"],
                "التسويق والمبيعات": ["CMO مدير تسويق","مدير تسويق","أخصائي تسويق رقمي","مدير مبيعات","مندوب مبيعات","أخصائي محتوى","مدير علاقات عملاء","أخصائي SEO/SEM","مدير منتجات","أخصائي إعلانات","مدير العلامة التجارية","أخصائي CRM","مدير تطوير أعمال"],
                "العمليات والإدارة": ["COO مدير عمليات","مدير عمليات","مدير إداري","سكرتير تنفيذي","مساعد إداري","أخصائي مشتريات","مدير سلسلة إمداد","مدير جودة","مدير مستودعات","أخصائي لوجستيات","مدير منشآت","موظف استقبال"],
                "القانون والامتثال": ["مستشار قانوني أول","مستشار قانوني","أخصائي امتثال","مدير حوكمة","محامي شركات","أخصائي عقود","مدير مخاطر","أخصائي حماية بيانات"],
                "التصميم والإبداع": ["مصمم جرافيك","مصمم UX/UI","مدير إبداعي","مصمم موشن","مصور فيديو","كاتب محتوى إبداعي","مدير إنتاج"],
                "الهندسة": ["مدير هندسة","مهندس مدني","مهندس كهربائي","مهندس ميكانيكي","مهندس صناعي","مهندس معماري","مهندس بيئي","فني صيانة"],
                "الطب والصحة": ["طبيب عام","طبيب أخصائي","طبيب استشاري","صيدلي","ممرض","أخصائي أشعة","فني مختبر","مدير مستشفى","أخصائي تأمين صحي"],
                "التعليم والتدريب": ["مدير تعليمي","معلم","أستاذ جامعي","مدرب مهني","مصمم تعليمي","أخصائي تطوير مهني","مدير أكاديمية"],
                "خدمة العملاء": ["مدير خدمة عملاء","أخصائي خدمة عملاء","مشرف مركز اتصال","أخصائي دعم فني","مدير تجربة العملاء"],
                "الإعلام والاتصال": ["مدير اتصال مؤسسي","أخصائي علاقات عامة","صحفي","مدير وسائل تواصل","مذيع","محرر"],
                "السياحة والضيافة": ["مدير فندق","مدير مطعم","شيف رئيسي","مرشد سياحي","أخصائي حجوزات","مدير فعاليات"],
                "العقارات": ["مدير عقارات","وسيط عقاري","مثمن عقاري","مدير تطوير عقاري","مدير إدارة أملاك"],
                "النفط والطاقة": ["مهندس بترول","مهندس طاقة","فني حفر","مدير عمليات نفطية","أخصائي بيئة وسلامة","مهندس طاقة متجددة"],
            }

            # Salary base includes new categories
            SALARY_BASE_EXTRA = {
                "الهندسة": {0:5000,2:7500,5:12000,10:18000,15:25000,20:32000},
                "الطب والصحة": {0:6000,2:9000,5:15000,10:25000,15:35000,20:50000},
                "التعليم والتدريب": {0:4000,2:5500,5:8000,10:12000,15:16000,20:20000},
            ...
            if st.button("🔍 كشف الأجور والمقارنة", type="primary", use_container_width=True, key="gsb"):
                if not selected_countries:
                    ...
                    CMULT = {"🇸🇦 السعودية":1.0,"🇦🇪 الإمارات":1.15,"🇶🇦 قطر":1.1,"🇰🇼 الكويت":1.05,"🇧🇭 البحرين":0.85,"🇴🇲 عُمان":0.8,"🇪🇬 مصر":0.22,"🇯🇴 الأردن":0.35,"🇱🇧 لبنان":0.25,"🇮🇶 العراق":0.3,"🇸🇾 سوريا":0.1,"🇵🇸 فلسطين":0.3,"🇾🇪 اليمن":0.08,"🇮🇷 إيران":0.2,"🇹🇷 تركيا":0.3,"🇨🇾 قبرص":0.9,"🇲🇦 المغرب":0.28,"🇹🇳 تونس":0.25,"🇩🇿 الجزائر":0.22,"🇱🇾 ليبيا":0.25,"🇸🇩 السودان":0.08,"🇲🇷 موريتانيا":0.12,"🇮🇳 الهند":0.18,"🇵🇰 باكستان":0.12,"🇧🇩 بنغلاديش":0.08,"🇱🇰 سريلانكا":0.1,"🇳🇵 نيبال":0.07,"🇦🇫 أفغانستان":0.06,"🇲🇻 المالديف":0.25,"🇧🇹 بوتان":0.07,"🇵🇭 الفلبين":0.15,"🇮🇩 إندونيسيا":0.13,"🇸🇬 سنغافورة":1.5,"🇲🇾 ماليزيا":0.35,"🇹🇭 تايلاند":0.25,"🇻🇳 فيتنام":0.12,"🇲🇲 ميانمار":0.07,"🇰🇭 كمبوديا":0.1,"🇱🇦 لاوس":0.08,"🇧🇳 بروناي":0.9,"🇹🇱 تيمور الشرقية":0.08,"🇨🇳 الصين":0.55,"🇯🇵 اليابان":1.4,"🇰🇷 كوريا الجنوبية":1.2,"🇹🇼 تايوان":0.9,"🇭🇰 هونغ كونغ":1.3,"🇲🇳 منغوليا":0.15,"🇰🇵 كوريا الشمالية":0.05,"🇬🇧 بريطانيا":1.8,"🇩🇪 ألمانيا":1.7,"🇫🇷 فرنسا":1.6,"🇮🇹 إيطاليا":1.4,"🇪🇸 إسبانيا":1.2,"🇳🇱 هولندا":1.65,"🇧🇪 بلجيكا":1.6,"🇨🇭 سويسرا":2.2,"🇦🇹 النمسا":1.55,"🇸🇪 السويد":1.7,"🇳🇴 النرويج":1.85,"🇩🇰 الدنمارك":1.8,"🇫🇮 فنلندا":1.55,"🇮🇪 أيرلندا":1.6,"🇵🇹 البرتغال":0.85,"🇬🇷 اليونان":0.8,"🇱🇺 لوكسمبورغ":2.0,"🇮🇸 آيسلندا":1.9,"🇲🇹 مالطا":0.85,"🇵🇱 بولندا":0.65,"🇷🇴 رومانيا":0.45,"🇨🇿 التشيك":0.7,"🇭🇺 المجر":0.5,"🇺🇦 أوكرانيا":0.18,"🇷🇺 روسيا":0.35,"🇧🇬 بلغاريا":0.4,"🇭🇷 كرواتيا":0.6,"🇷🇸 صربيا":0.35,"🇸🇰 سلوفاكيا":0.65,"🇸🇮 سلوفينيا":0.8,"🇱🇹 ليتوانيا":0.55,"🇱🇻 لاتفيا":0.5,"🇪🇪 إستونيا":0.6,"🇧🇦 البوسنة":0.3,"🇦🇱 ألبانيا":0.25,"🇲🇰 مقدونيا":0.3,"🇲🇩 مولدوفا":0.15,"🇧🇾 بيلاروسيا":0.2,"🇽🇰 كوسوفو":0.25,"🇲🇪 الجبل الأسود":0.35,"🇺🇸 أمريكا":2.0,"🇨🇦 كندا":1.65,"🇲🇽 المكسيك":0.3,"🇨🇺 كوبا":0.08,"🇯🇲 جامايكا":0.12,"🇩🇴 الدومينيكان":0.15,"🇭🇹 هايتي":0.05,"🇹🇹 ترينيداد":0.3,"🇵🇦 بنما":0.25,"🇨🇷 كوستاريكا":0.22,"🇬🇹 غواتيمالا":0.12,"🇧🇷 البرازيل":0.4,"🇦🇷 الأرجنتين":0.2,"🇨🇱 تشيلي":0.5,"🇨🇴 كولومبيا":0.25,"🇵🇪 بيرو":0.25,"🇪🇨 الإكوادور":0.22,"🇺🇾 أوروغواي":0.4,"🇻🇪 فنزويلا":0.08,"🇧🇴 بوليفيا":0.12,"🇵🇾 باراغواي":0.15,"🇳🇬 نيجيريا":0.15,"🇬🇭 غانا":0.1,"🇸🇳 السنغال":0.12,"🇨🇮 ساحل العاج":0.1,"🇨🇲 الكاميرون":0.08,"🇲🇱 مالي":0.06,"🇧🇫 بوركينا فاسو":0.05,"🇳🇪 النيجر":0.05,"🇬🇳 غينيا":0.05,"🇹🇬 توغو":0.05,"🇧🇯 بنين":0.06,"🇸🇱 سيراليون":0.05,"🇰🇪 كينيا":0.12,"🇪🇹 إثيوبيا":0.06,"🇹🇿 تنزانيا":0.07,"🇺🇬 أوغندا":0.06,"🇷🇼 رواندا":0.07,"🇲🇬 مدغشقر":0.05,"🇸🇴 الصومال":0.04,"🇩🇯 جيبوتي":0.1,"🇪🇷 إريتريا":0.04,"🇲🇼 مالاوي":0.04,"🇿🇦 جنوب أفريقيا":0.3,"🇲🇺 موريشيوس":0.25,"🇧🇼 بوتسوانا":0.2,"🇲🇿 موزمبيق":0.06,"🇿🇲 زامبيا":0.07,"🇿🇼 زيمبابوي":0.06,"🇳🇦 ناميبيا":0.18,"🇨🇩 الكونغو الديمقراطية":0.04,"🇨🇬 الكونغو":0.06,"🇬🇦 الغابون":0.2,"🇹🇩 تشاد":0.05,"🇬🇶 غينيا الاستوائية":0.15,"🇪🇭 الصحراء الغربية":0.15,"🇦🇺 أستراليا":1.75,"🇳🇿 نيوزيلندا":1.55,"🇫🇯 فيجي":0.15,"🇵🇬 بابوا غينيا":0.1,"🇰🇿 كازاخستان":0.25,"🇺🇿 أوزبكستان":0.1,"🇬🇪 جورجيا":0.3,"🇦🇿 أذربيجان":0.25,"🇦🇲 أرمينيا":0.2,"🇹🇲 تركمانستان":0.12,"🇹🇯 طاجيكستان":0.07,"🇰🇬 قيرغيزستان":0.08}



                    base_s = SALARY_BASE.get(job_cat, SALARY_BASE_EXTRA.get(job_cat, SALARY_BASE["العمليات والإدارة"]))
        ...
        if page == "📜 إنشاء عقد":
            ...
            if ana_file:
                ...
                if any(kw in contract_text for kw in ["المادة 77","تعويض","فصل غير مشروع","إنهاء غير مشروع"]):
                    compliance.append({"البند":"التعويض عن الإنهاء","المادة":"77","التوافق":"✅ متوافق","الملاحظة":"إذا تضمّن العقد تعويضاً محدداً يُعمل به. وإلا: 15 يوم/سنة (غير محدد) أو المدة الباقية (محدد)، بحد أدنى شهرين"})
                else:
...
أجب بنفس لغة العقد أو السؤال."""
    ...
    # =========================================
        ...
        LABOR_LAW_SYSTEM_PROMPT = """⚖️ أنت المستشار القانوني لنظام العمل السعودي (المعدّل بالمرسوم الملكي م/44، نافذ 19/2/2025).

❌ ممنوع: لا تذكر أي مفاهيم إدارية أو نماذج HR. أجب فقط بالمواد القانونية وأرقامها.

⚠️ تعليمات صارمة لمنع الأخطاء القانونية:
1. اقرأ السؤال 3 مرات قبل الإجابة. افهم ماذا يسأل بالضبط.
2. كثير من المواد لها شروط وقيود واستثناءات. لا تُعطِ الحكم العام بدون ذكر الشروط.
3. إذا كانت المادة تقول "ما لم يتضمن العقد..." أو "في حال عدم..." فهذا يعني أن الحكم مشروط وليس مطلقاً. اذكر الشرط أولاً.
4. لا تُعطِ إجابة مبسّطة مضللة. الدقة أهم من الإيجاز.
5. لا تختلق أرقام مواد. النظام يحتوي على المواد 1 إلى 245 فقط.
6. إذا لم تكن متأكداً 100% من نص المادة، اكتب "يُرجع للنص الرسمي للتحقق".

**منهجية التحليل (اتبعها في كل إجابة):**

🔍 **الخطوة 1 - فهم السؤال:** ما المسألة القانونية بالضبط؟ ما الظروف والملابسات؟
📋 **الخطوة 2 - المواد ذات العلاقة:** اذكر كل مادة مرتبطة مع نصها الدقيق والشروط والاستثناءات
⚖️ **الخطوة 3 - التحليل المشروط:** هل يوجد شرط في العقد يغيّر الحكم؟ هل يوجد استثناء؟
🔢 **الخطوة 4 - الحسابات:** إذا لزم، احسب المستحقات بالأرقام مع كل الاحتمالات
👤 **الخطوة 5 - حقوق الطرفين:** ما حقوق العامل وما حقوق صاحب العمل
💡 **الخطوة 6 - التوصية:** نصيحة عملية + الجهة المختصة (مكتب العمل / المحكمة العمالية)
⚠️ **الخطوة 7 - التنبيه:** هذه استشارة أولية وليست رأياً قانونياً نهائياً

**أمثلة على الدقة المطلوبة:**
- المادة 77: التعويض المذكور يُطبق فقط "إذا لم يتضمن العقد تعويضاً محدداً". إذا تضمّن العقد شرطاً فيُعمل بالعقد.
- المادة 53: فترة التجربة أقصاها 180 يوماً (المعدّلة)، لا يجوز تمديدها بعد التعديل.
- المادة 80: الفصل بدون مكافأة يشترط غياب أكثر من 15 يوماً متصلة (بعد إنذار كتابي عند 10 أيام).
- المادة 84-85: المكافأة تختلف حسب سبب الانتهاء (إنهاء صاحب عمل / استقالة / اتفاق).
...
GOSI: قديم (قبل 7/2024) موظف 9.75% + شركة 11.75% | جديد (بعد 7/2024) حالياً موظف 10.25% + شركة 12.25% | غير سعودي 2% شركة فقط

أجب بنفس لغة السؤال (عربي أو إنجليزي). اتبع الخطوات السبع. الدقة أولاً."""
...
- HR Analytics: Descriptive→Diagnostic→Predictive→Prescriptive"""
        ...
        if page == "⚖️ المستشار القانوني":
            ...
            **المصادر المعتمدة:**
            ...
            if st.session_state.labor_chat:
                ...
                for idx, msg in enumerate(st.session_state.labor_chat):
                    if msg['role'] == 'user':
                        ...
                        with fc1:
                            if st.button("👍", key=f"lg_{idx}", help="مفيدة"):
                                rate_answer(q_hash, 1, "legal"); st.toast("شكراً")
                        with fc2:
                            if st.button("👎", key=f"lb_{idx}", help="غير دقيقة"):
                                rate_answer(q_hash, -1, "legal"); st.toast("سيتم التحسين")
                if st.button("🗑️ مسح المحادثة", key="labor_clear"):
                    st.session_state.labor_chat = []
                    st.rerun()
                st.markdown("---")

            # === THEN: Quick buttons and form below ===

            # Chat history display FIRST (above form)
            if 'labor_chat' not in st.session_state:
                st.session_state.labor_chat = []
            ...
            # Input - NO form, use button + session_state
            ...
            if '_pending_labor_q' in st.session_state:
                ...
                with st.spinner("جاري التحليل القانوني..."):
                    try:
                        ...
                        # Step 1: Analyze question (topic, intent, party, entities)
                        analysis = analyze_question(pending_q, "legal")

                        # Step 2: Search KB for relevant reference material
                        kb_ref = search_kb(pending_q, LABOR_KB, max_results=3)

                        # Step 3: Build advanced reasoning context
                        reasoning_ctx = build_reasoning_context(pending_q, "legal", analysis, kb_ref)

                        # Step 4: Build system prompt with anti-hallucination guards
                        sys_p = reasoning_ctx
                        sys_p += "\n\n🚫 **قواعد صارمة لمنع الهلوسة:**\n"
                        sys_p += "1. أجب حصرياً من المرجع القانوني المرفق مع السؤال. لا تضف معلومات من خارجه.\n"
                        sys_p += "2. إذا لم تجد الإجابة في المرجع، قل بوضوح: 'لم أجد في المرجع المتاح إجابة دقيقة لهذا السؤال'.\n"
                        sys_p += "3. لا تخترع أرقام مواد. إذا لم تتأكد من رقم المادة، لا تذكره.\n"
                        sys_p += "4. لا تخلط بين المواد. كل مادة لها نطاق محدد.\n"
                        sys_p += "5. أجب بنفس لغة السؤال.\n"
                        sys_p += "6. اذكر رقم المادة بوضوح عند كل حكم قانوني.\n"

                        # Step 5: Build user message with KB reference
                        if kb_ref:
                            # Include verified facts from LEGAL_TOPICS if available
                            facts = analysis.get('facts', '')
                            user_msg = f"السؤال: {pending_q}\n\n"
                            if facts:
                                user_msg += f"📋 الحقائق القانونية الموثّقة لهذا الموضوع:\n{facts}\n\n"
                            user_msg += f"المرجع القانوني (أجب منه فقط):\n{kb_ref}\n\n"
                            user_msg += "أجب على السؤال أعلاه بناءً على المرجع القانوني فقط. لا تذكر معلومات غير موجودة في المرجع. إذا احتجت معلومة غير موجودة في المرجع، وضّح ذلك."
                        else:
                            user_msg = f"السؤال: {pending_q}\n\nلا يوجد مرجع محدد. أجب من معرفتك بنظام العمل السعودي المعدّل 2025 مع ذكر أرقام المواد. إذا لم تتأكد من رقم مادة، لا تذكره."

                        # Step 6: Inject learning from past feedback
                        ...
                        if response and len(response) > 20:
                            # Step 8: Post-process corrections
                            response = verify_and_correct_response(response, "legal")

                            # Step 9: Filter domain contamination
                            response = filter_response(response, "legal")

                            # Step 10: Verify answer quality
                            is_valid, issues, conf = verify_answer(response, analysis, "legal")
                            if not is_valid and "hallucinated" in str(issues):
                                # Retry with stronger anti-hallucination
                                retry_msg = user_msg + "\n\n⚠️ أعد الإجابة. استخدم فقط المواد الموجودة في المرجع. لا تخترع أرقام مواد."
                                response2, error2 = call_ai_api(sys_p, retry_msg, model_type="labor_law")
                                if response2 and len(response2) > 20:
                                    response = verify_and_correct_response(response2, "legal")
                                    response = filter_response(response, "legal")

                            auto_learn_from_answer(pending_q, response, "legal")
                            st.session_state.labor_chat = [{"role":"user","content":pending_q},{"role":"assistant","content":response}]
                        else:
                            st.session_state.labor_chat = [{"role":"user","content":pending_q},
                                {"role":"assistant","content":f"تعذرت الإجابة: {error or 'لا يوجد رد'}\n\nتأكد من إعداد مفتاح API (Gemini مجاني أو Groq)."}]
                    except Exception as e:
                        st.session_state.labor_chat = [{"role":"user","content":pending_q},
                            {"role":"assistant","content":f"خطأ تقني: {str(e)[:200]}"}]
                    st.rerun()
            ...
            **ملاحظة:** هذا المستشار متخصص في المفاهيم العلمية والأطر المنهجية لإدارة الموارد البشرية. للاستشارات القانونية ونظام العمل، استخدم **المستشار القانوني**.
            ...
            if st.session_state.hr_chat:
                ...
                for idx, msg in enumerate(st.session_state.hr_chat):
                    if msg['role'] == 'user':
                        ...
                        q_hash = hashlib.md5(q_text.encode()).hexdigest()[:10] if q_text else ""
                        with fc1:
                            if st.button("👍", key=f"hg_{idx}", help="مفيدة"):
                                rate_answer(q_hash, 1, "hr"); st.toast("شكراً")
                        with fc2:
                            if st.button("👎", key=f"hb_{idx}", help="غير دقيقة"):
                                rate_answer(q_hash, -1, "hr"); st.toast("سيتم التحسين")
                if st.button("🗑️ مسح المحادثة", key="hr_clear"):
                    st.session_state.hr_chat = []
                    st.rerun()
                st.markdown("---")
            ...
            if '_pending_hr_q' in st.session_state:
                ...
                with st.spinner("جاري التحليل المهني..."):
                    try:
                        # === ADVANCED HR REASONING PIPELINE ===

                        # Step 1: Analyze question
                        analysis = analyze_question(pending_q, "hr")

                        # Step 2: Search KB + RAG for relevant reference
                        kb_ref = search_kb(pending_q, HR_KB, max_results=3)
                        rag_ctx = ""
                        try:
                            if '_knowledge_engine' in st.session_state:
                        ...
                        # Step 3: Build advanced reasoning context
                        reasoning_ctx = build_reasoning_context(pending_q, "hr", analysis, ref_text)

                        # Step 4: System prompt with anti-hallucination
                        sys_p = reasoning_ctx
                        sys_p += "\n\n🚫 **قواعد صارمة:**\n"
                        sys_p += "1. أجب حصرياً من المرجع المهني المرفق. لا تذكر مواد قانونية أو أرقام مواد.\n"
                        sys_p += "2. اربط كل توصية بمنهج معتمد (PHRi/SHRM/CIPD/APTD) مع ذكر المصدر.\n"
                        sys_p += "3. إذا لم تتأكد من إطار منهجي، قل 'بحسب أفضل الممارسات المهنية'.\n"
                        sys_p += "4. أجب بنفس لغة السؤال.\n"
                        ...
                        if ref_text:
                            ...
                            user_msg = f"السؤال: {pending_q}\n\n"
                            if hr_facts:
                                user_msg += f"📚 الأطر الموثّقة:\n{hr_facts}\n\n"
                            user_msg += f"المرجع المهني (أجب منه فقط):\n{ref_text}\n\n"
                            user_msg += "أجب على السؤال بناءً على المرجع أعلاه فقط. لا تذكر مواد قانونية."
                        else:
                            user_msg = f"السؤال: {pending_q}\n\nأجب من معرفتك بأطر PHRi/SHRM/CIPD/APTD. لا تذكر مواد قانونية."
                        ...
                        if response and len(response) > 20:
                            # Step 8: Filter domain contamination
                            response = filter_response(response, "hr")

                            # Step 9: Verify
                            is_valid, issues, conf = verify_answer(response, analysis, "hr")
                            if not is_valid and "legal_contamination" in issues:
                                retry_msg = user_msg + "\n\n⚠️ أعد الإجابة بدون أي مواد قانونية. فقط مناهج مهنية."
                                response2, error2 = call_ai_api(sys_p, retry_msg, model_type="hr")
                                if response2 and len(response2) > 20:
                                    response = filter_response(response2, "hr")
...
أجب بنفس لغة السؤال بأسلوب مهني."""
